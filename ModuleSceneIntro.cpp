...
#pragma region cubes
	...
	//y es la x
	//z es la y
	c180 = Cube(100.0, 0.5, 10);
	c180.SetPos(203.581, -0.499997, 28.3756);
	c180.SetRotation(0, vec3(0, 0, 0));
	...
	//y es la x
	//z es la y
	c187 = Cube(112.6, 0.5, 10);
	c187.SetPos(557.261, 52.4062, 28.4111);
	c187.SetRotation(0, vec3(0, 0, 0));
